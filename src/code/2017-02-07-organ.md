...
js:
  lang: javascript
  code: |-
    import { createAmplitudeEnvelope, createFreeverb, createGain, createOmniOscillator, createPiano, MultiSynth } from '/code/2017/02/07/nexus-tone-components/script.js';
